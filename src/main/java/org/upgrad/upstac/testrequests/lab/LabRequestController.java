...
public class LabRequestController {
    ...
    public List<TestRequest> getForTester()  {
        ...
        //Implemented this method to return the list of test requests assigned to current tester(make use of the above created User object)
        ...
        // throw new ResponseStatusException(HttpStatus.NOT_IMPLEMENTED,"Not implemented"); <-- replaced this line with my code
